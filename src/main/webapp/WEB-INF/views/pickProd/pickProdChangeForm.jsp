...
<body>
	...
	<div class="container">
		<div class="col-lg-12 mb20">
			<div class="contact-form">
				<h1 class="contact-info-title">펀드 일괄변경</h1>
			</div>
		</div>
	</div>
		...
		<form id="updateForm">
			<h2 class="custom-heading">
				<img src="/resources/images/rating.png" alt=""
					style="width: 40px; height: 35px;"> 선택상품의 투자비율을 입력해주세요.
			</h2>
					...
					<c:forEach items="${pickProdList}" var="pickProd">
						<tr style="text-align: center;">
							...
							<td><input type="number"
								id="investRatio_${pickProd.productId}" placeholder=0
								name="investRatio" min="0" max="100" required />% <input
								type="hidden" name="productId" value="${pickProd.productId}"></td>
						</tr>
					</c:forEach>
				</tbody>
				<tfoot>
         ...
         <button type="button" id="changeSubmitBtn" class="btn btn-primary">상품비율선택</button>
            </div>				
	...
	<script src="/resources/js/changePickProduct.js"></script>
</body>
</html>