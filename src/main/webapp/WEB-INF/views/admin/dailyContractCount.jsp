...
<body>
 ...
 <!--   <div class="space-small"></div> -->
   ...
   <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    ...
    <script>
    var newContractDataListJson = ${newContractDataListJson}; // JSON 데이터를 JavaScript 변수에 할당
</script>
<script src="/resources/js/daily.js"></script>  
<!--    <script>
        const ctxBar = document.getElementById('dailyContract');
      const contractCountList = JSON.parse('${newContractDataListJson}');
      console.log("11contractCountList:", contractCountList);

      var labelListBar = new Array();
      var valueListBar = new Array();
      var colorListBar = new Array();

      for (var i = 0; i < contractCountList.length; i++) {
         var d = contractCountList[i];
         labelListBar.push(d.entry_date);
         valueListBar.push(d.contract_count);
         colorListBar.push(colorize());
      }
